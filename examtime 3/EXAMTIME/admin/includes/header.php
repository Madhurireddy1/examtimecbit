<?php
		...
		if ($_COOKIE["auth"] != "admin_in"){header("location:"."./");}
			...
			<head>
				...
				<title>Examtimedb Admin Panel</title>
			...
			<li><a href="contact.php"> <i class="glyphicon glyphicon-backward"></i>Contact <span class="pull-right"><?=counting("contact", "id")?></span></a></li>
<li><a href="user.php"> <i class="glyphicon glyphicon-signal"></i>User <span class="pull-right"><?=counting("user", "id")?></span></a></li>
<li><a href="users.php"> <i class="glyphicon glyphicon-duplicate"></i>Users <span class="pull-right"><?=counting("users", "id")?></span></a></li>
