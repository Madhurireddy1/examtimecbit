...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message'])) {
		...
		if ($conn->query($sql) === true) {
			# code...
			$sub = "Contact from Website - EXAMTIME";
			$body = "name: $name\nEmail: $email\nSubject: $subject\nMessage: $msg";
			...
			$to      = 'examtime.cbit@gmail.com';
			$header = "From: examtime.cbit@gmail.com"."\r\n"."Reply-To: $email";
			mail($to, $sub, $body, $headers);
			// mail('examtime.cbit@gmail.com',$sub,$body,$header);
			?>
	...
	<div class="container">
		<div class="contact-main">
			...
			<div class="contact-block1">
			 	...
			 	<ul>
			    	<li><span class="glyphicon glyphicon-map-marker" aria-hidden="true"> </span><p>Administrator EXAMTIME</p></li>
			    	<li><span class="glyphicon glyphicon-phone" aria-hidden="true"> </span><p>987654321</p></li>
			    	<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span><p><a href="mailto:examtime.cbit@gmail.com">examtime.cbit@gmail.com</a></p></li>
			    </ul>
			 	</div>
